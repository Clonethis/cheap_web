/**
 * v0 by Vercel.
 * @see https://v0.dev/t/vQhk6FzvS8w
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                Ready to Take Your Business Online? <br></br>Let's Build Your Website!
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Beautifully designed web that you can copy and paste into your apps. Accessible. Customizable.
                  Open Source.
                </p>
              </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid items-center gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
              <img
                ...
                height="310"
                src="/images/laptop_with_text.jpg"
                width="550"
              />
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  Unlock Your Business Potential with Our Economical Web Design Services.
                  </h2>
